...
func (p *FallbackClientsNimbus) Page() tview.Primitive {
	...
	bodyText := `Fallback Clients > Nimbus

Please note that you have selected Nimbus as your primary Consensus client. To
...
JSON-RPC URL for your fallback Nimbus node.
			
e.g. http://192.168.1.45:8545 for your Execution client and
http://192.168.1.45:5052 for your fallback Nimbus node.`
...
func (p *FallbackClientsNimbus) onSumit() {
